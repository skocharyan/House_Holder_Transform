classdef (Sealed,StrictDefaults) CustomTimeDelayLCMVBeamformer < CustomAbstractTimeDomainSMIBeamformer
...
%#codegen
    ...
    methods
        function obj = CustomTimeDelayLCMVBeamformer(varargin)
            obj = obj@CustomAbstractTimeDomainSMIBeamformer(varargin{:});
        end
    end
    ...
    methods (Access = 'protected')
        ...
        function validatePropertiesImpl(obj)
            validatePropertiesImpl@CustomAbstractTimeDomainSMIBeamformer(obj);
        ...
        function setupImpl(obj, varargin)
            setupImpl@CustomAbstractTimeDomainSMIBeamformer(obj, varargin{:});
    ...
    methods (Static,Hidden,Access=protected)
        function groups = getPropertyGroupsImpl
            groups = getPropertyGroupsImpl@CustomAbstractTimeDomainBeamformer('array');
            props = {...
