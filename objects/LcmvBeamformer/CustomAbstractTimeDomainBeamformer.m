classdef (Hidden) CustomAbstractTimeDomainBeamformer < phased.internal.AbstractBeamformer
...
%#codegen
    ...
    properties (Nontunable)
        ...
        %   used in Simulink.
        SampleRateFromInputCheckbox (1, 1) logical = true
    ...
    properties (Constant, Hidden)
        SampleRateSet = matlab.system.SourceSet({'PropertyOrMethod',...
            ...
            'getSampleRateInSimulation',true})
    end
    ...
    methods (Access = protected)
        ...
        function obj = CustomAbstractTimeDomainBeamformer(varargin)
